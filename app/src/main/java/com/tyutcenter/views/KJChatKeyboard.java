...
import com.tyutcenter.views.chat.FaceCategroyAdapter;
    ...
    private void initWidget() {
        ...
        mEtMsg.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (CommonUtil.isStrEmpty(mEtMsg.getText().toString())){
                    mBtnSend.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_feedback_item_gray));
                    mBtnSend.setClickable(false);
                    return;
                }else {
                    mBtnSend.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_feedback_item_green));
