...
public class NewsFragment1 extends BaseFragment<MainPresenter.MainUiCallback> implements MainPresenter.NewsUi{
    ...
    public void getNewsCallback(List<News> newsList,boolean isRefresh) {
        ...
        CommonUtil.setShardPString("news1", mGson.toJson(mAdapter.getData()));
    }
    ...
    public void getNewsCountCallback(NewsCount newsCount) {
        if (newsCount != null){
            ...
            CommonUtil.setShardPString("news1_count",mGson.toJson(newsCount));
        }
    }
    ...
    protected void lazyLoad() {
        String news1 = CommonUtil.getShardPStringByKey("news1");
        String news1_count = CommonUtil.getShardPStringByKey("news1_count");
        ...
        if (CommonUtil.isStrEmpty(news1_count)){
            String url = Constants.base_url+"/xyxw/lgyw.htm";
