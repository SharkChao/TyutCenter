...
public class NewsFragment5 extends BaseFragment<MainPresenter.MainUiCallback> implements MainPresenter.NewsUi{

    private String url = "xyxw/xshd";
    private static NewsFragment5 fragment_news1;
    ...
    public void getNewsCallback(List<News> newsList,boolean isRefresh) {
        ...
        CommonUtil.setShardPString("news5", mGson.toJson(mAdapter.getData()));
    }
    ...
    public static NewsFragment5 getInstance(){
        if (fragment_news1 == null){
            fragment_news1 = new NewsFragment5();
        }
    ...
    protected void lazyLoad() {
        String news1 = CommonUtil.getShardPStringByKey("news5");
        String news1_count = CommonUtil.getShardPStringByKey("news5_count");
        ...
        if (CommonUtil.isStrEmpty(news1_count)){
            String url = Constants.base_url+"/xyxw/xshd.htm";
