...
public class NewsFragment4 extends BaseFragment<MainPresenter.MainUiCallback> implements MainPresenter.NewsUi{
    ...
    public void getNewsCallback(List<News> newsList,boolean isRefresh) {
        ...
        CommonUtil.setShardPString("news4", mGson.toJson(mAdapter.getData()));
    }
    ...
    protected void lazyLoad() {
        String news1 = CommonUtil.getShardPStringByKey("news4");
        String news1_count = CommonUtil.getShardPStringByKey("news4_count");
        ...
        if (CommonUtil.isStrEmpty(news1_count)){
            String url = Constants.base_url+"/xyxw/splg.htm";
